...
class AlgoritmoGenetico:
    def __init__(self, TAM_POP, TAM_GENE, numero_geracoes = 100):
        print("Algoritmo Genético. Executado por Emannuel Oliveira.")
    ...
    def operadores_geneticos(self):
        ...
        for geracao in range(self.numero_geracoes):
            ...
            self.aptidao_evolucao.append(apt)
        ...
        # Exibir gráfico da evolução da aptidão
        self.exibe_grafico_evolucao()
    ...
    def exibe_grafico_evolucao(self):
        plt.plot(range(self.numero_geracoes), self.aptidao_evolucao)
        plt.xlabel('Gerações')
        plt.ylabel('Aptidão')
...
algoritmo = AlgoritmoGenetico(TAM_POP=10, TAM_GENE=10, numero_geracoes=50)
algoritmo.operadores_geneticos()
